...
class ClientController extends Controller
{
    ...
    public function store(ClientRequest $request, Client $client)
    {
        ...
        return redirect()->route('clients.index')->withStatus('Client enregistré avec succès.');
    }
    ...
    public function update(ClientRequest $request, Client $client)
    {
        ...
        return redirect()
            ->route('clients.index')
            ->withStatus('Client modifié avec succès.');
    }
    ...
    public function destroy(Client $client)
    {
        ...
        return redirect()
            ->route('clients.index')
            ->withStatus('Le client a bien été supprimé.');
    }
