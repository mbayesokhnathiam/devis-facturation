...
class MethodController extends Controller
{
    ...
    public function store(Request $request, PaymentMethod $method)
    {
        ...
        return redirect()
            ->route('methods.index')
            ->withStatus('Mode de paiement créé avec succès.');
    }
    ...
    public function update(Request $request, PaymentMethod $method)
    {
        ...
        return redirect()
            ->route('methods.index')
            ->withStatus('Mode de paiement mis à jour de manière satisfaisante.');
    }
    ...
    public function destroy(PaymentMethod $method)
    {
        ...
        return back()->withStatus('Le mode de paiement a bien été supprimé.');
    }
}
