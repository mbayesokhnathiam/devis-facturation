...
class ReceiptController extends Controller
{
    ...
    public function store(Request $request, Receipt $receipt)
    {
        ...
        return redirect()
            ...
            ->withStatus('Reçu enregistré avec succès, vous pouvez commencer à ajouter les produits qui lui appartiennent.');
    }
    ...
    public function destroy(Receipt $receipt)
    {
        ...
        return redirect()
            ...
            ->withStatus('Le reçu a bien été supprimé.');
    }
    ...
    public function finalize(Receipt $receipt)
    {
        ...
        return back()->withStatus('Reçu terminé avec succès.');
    }
    ...
    public function storeproduct(Request $request, Receipt $receipt, ReceivedProduct $receivedproduct)
    {
        ...
        return redirect()
            ->route('receipts.show', $receipt)
            ->withStatus('Produit ajouté avec succès.');
    }
    ...
    public function updateproduct(Request $request, Receipt $receipt, ReceivedProduct $receivedproduct)
    {
        ...
        return redirect()
            ->route('receipts.show', $receipt)
            ->withStatus('Produit modifié avec succès.');
    }
