@extends('layouts.app', ['page' => 'Modifier produit', 'pageSlug' => 'sales', 'section' => 'transactions'])
                    ...
                    <div class="card-header">
                        <div class="row align-items-center">
                            ...
                            <div class="col-4 text-right">
                                <a href="{{ route('return.sale.product', [$sale]) }}" class="btn btn-sm btn-primary">Retour</a>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
                        <form method="post" action="{{ route('return.product.update', ['sale' => $sale, 'soldproduct' => $soldproduct]) }}" autocomplete="off">
                            @csrf
                            @method('put')
