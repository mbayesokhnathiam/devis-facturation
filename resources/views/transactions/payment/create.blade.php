@extends('layouts.app', ['page' => 'Nouveau paiement', 'pageSlug' => 'Nouveau paiement', 'section' => 'transactions'])
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="post" action="{{ route('transactions.store') }}" autocomplete="off">
                            ...
                            <h6 class="heading-small text-muted mb-4">Information paiement</h6>
                            <div class="pl-lg-4">
                                ...
                                <div class="form-group{{ $errors->has('reference') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="reference" id="input-reference" class="form-control form-control-alternative{{ $errors->has('reference') ? ' is-invalid' : '' }}" placeholder="Référence" value="{{ old('reference') }}">
