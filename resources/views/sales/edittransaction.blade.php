@extends('layouts.app', ['page' => 'Modifier transaction', 'pageSlug' => 'sales', 'section' => 'transactions'])
                ...
                <div class="card">
                    <div class="card-header">
                        <div class="row align-items-center">
                            <div class="col-8">
                                <h3 class="mb-0">Modifier Transaction</h3>
                            </div>
                            <div class="col-4 text-right">
                                <a href="{{ route('sales.show', $sale) }}" class="btn btn-sm btn-primary">Retour à la vente</a>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
                        <form method="post" action="{{ route('sales.transaction.update', ['sale' => $sale, 'transaction' => $transaction]) }}" autocomplete="off">
                            ...
                            <h6 class="heading-small text-muted mb-4">Informations sur la transaction</h6>
                            <div class="pl-lg-4">
                                <div class="form-group{{ $errors->has('type') ? ' has-danger' : '' }}">
                                    <label class="form-control-label" for="input-method">Type de transaction</label>
