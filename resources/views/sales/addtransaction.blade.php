@extends('layouts.app', ['page' => 'Nouvelle transaction', 'pageSlug' => 'sales', 'section' => 'transactions'])
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="post" action="{{ route('sales.transaction.store', $sale) }}" autocomplete="off">
                            ...
                            <h6 class="heading-small text-muted mb-4">Informations transactions</h6>
                            <div class="pl-lg-4">
                                <div class="form-group{{ $errors->has('type') ? ' has-danger' : '' }}">
                                    ...
                                    <select name="type" id="input-method" class="form-control form-control-alternative{{ $errors->has('type') ? ' is-invalid' : '' }}" required>
                                        @foreach (['Réception' => 'Paiement reçu', 'Dépense' => 'Retour paiment'] as $type => $title)
                                            @if($type == old('type'))
                                ...
                                <div class="form-group{{ $errors->has('payment_method_id') ? ' has-danger' : '' }}">
                                    <label class="form-control-label" for="input-method">Paiment Méthode</label>
