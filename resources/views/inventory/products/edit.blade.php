@extends('layouts.app', ['page' => 'Modifier produit', 'pageSlug' => 'products', 'section' => 'inventory'])
                        ...
                        <form method="post" action="{{ route('products.update', $product) }}" autocomplete="off">
                            ...
                            <div class="pl-lg-4">
                                ...
                                <div class="form-group{{ $errors->has('description') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="description" id="input-description" class="form-control form-control-alternative" placeholder="Déscription" value="{{ old('description', $product->description) }}">
