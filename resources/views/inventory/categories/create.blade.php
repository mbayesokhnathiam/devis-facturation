@extends('layouts.app', ['page' => 'Nouveau catégorie', 'pageSlug' => 'categories', 'section' => 'inventory'])
                ...
                <div class="card">
                    <div class="card-header">
                        <div class="row align-items-center">
                            <div class="col-8">
                                <h3 class="mb-0">Nouveau catégorie</h3>
                            </div>
                    ...
                    <div class="card-body">
                        <form method="post" action="{{ route('categories.store') }}" autocomplete="off">
                            ...
                            <h6 class="heading-small text-muted mb-4">Information catégorie</h6>
                            <div class="pl-lg-4">
