@extends('layouts.app', ['page' => 'Modifier catégorie', 'pageSlug' => 'categories', 'section' => 'inventory'])
                ...
                <div class="card">
                    <div class="card-header">
                        <div class="row align-items-center">
                            <div class="col-8">
                                <h3 class="mb-0">Modifier catégorie</h3>
                            </div>
                            <div class="col-4 text-right">
                                <a href="{{ route('categories.index') }}" class="btn btn-sm btn-primary">Retour à la liste des catégories</a>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
                        <form method="post" action="{{ route('categories.update', $category) }}" autocomplete="off">
                            ...
                            <h6 class="heading-small text-muted mb-4">Information de la catégorie</h6>
                            <div class="pl-lg-4">
