@extends('layouts.app', ['page' => 'Ajouter produit', 'pageSlug' => 'receipt', 'section' => 'inventory'])
                        ...
                        <form method="post" action="{{ route('receipts.product.store', $receipt) }}" autocomplete="off">
                            ...
                            <div class="pl-lg-4">
                                ...
                                <div class="form-group{{ $errors->has('price') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="number" name="price" id="input-price" class="form-control form-control-alternative{{ $errors->has('price') ? ' is-invalid' : '' }}" value="0" required>
