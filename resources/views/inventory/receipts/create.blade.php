@extends('layouts.app', ['page' => 'Nouvelle réception', 'pageSlug' => 'receipts', 'section' => 'inventory'])
                ...
                <div class="card">
                    <div class="card-header">
                        <div class="row align-items-center">
                            <div class="col-8">
                                <h3 class="mb-0">Nouvelle réception</h3>
                            </div>
                            <div class="col-4 text-right">
                                <a href="{{ route('receipts.index') }}" class="btn btn-sm btn-primary">retour à la liste</a>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
                        <form method="post" action="{{ route('receipts.store') }}" autocomplete="off">
                            ...
                            <h6 class="heading-small text-muted mb-4">Information réception</h6>
                            <div class="pl-lg-4">
